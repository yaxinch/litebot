...
class ContextManagementConfig(Base):
    ...
    tool_summary_max_chars: int = Field(default=1024, ge=1)
    artifact_page_size: int = Field(default=4096, ge=1)
    artifact_search_total_snippet_chars: int = Field(default=2000, ge=1)
    artifact_max_reads_per_session: int = Field(default=3, ge=1)
    artifact_max_searches_per_session: int = Field(default=5, ge=1)
    artifact_max_returned_chars_per_session: int = Field(default=12_288, ge=1)
    artifact_max_sequential_reads: int = Field(default=3, ge=1)
